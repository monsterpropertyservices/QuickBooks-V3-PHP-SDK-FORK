...
class ServiceContext
{
     ...
     */
    private function __construct($realmId, $serviceType = CoreConstants::IntuitServicesTypeQBO, mixed $requestValidator = null, ?IppConfiguration $ippConfiguration = null)
    {
